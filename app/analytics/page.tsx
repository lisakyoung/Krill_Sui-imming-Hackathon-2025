  ...
  const handleManageOption = (option: string) => {
    switch (option) {
      ...
      case "community":
        ...
        break;
      case "evolution":
        router.push("/evolution-settings");
        break;
      default:
        toast.info(`Opening ${option} settings...`);
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Content Preview - Properly display uploaded media */}
            <div className="glass-effect rounded-2xl overflow-hidden">
              <div className="relative bg-gradient-to-br from-purple-600/20 to-pink-600/20">
                ...
                {profile.uploadedContent?.type?.startsWith("audio") && (
                  <div className="flex items-center justify-center h-64 bg-gradient-to-br from-purple-600/20 to-pink-600/20">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">
                    ${(profile.sharePrice || 10) * 1.5}
                  </span>
                </div>
              </div>
            </div>

            {/* Management Options - All clickable */}
            <div className="glass-effect rounded-2xl p-6">
              <h3 className="text-lg font-semibold text-white mb-4">
                Content Management
              </h3>
              <div className="space-y-2">
                ...
                <button
                  onClick={() => handleManageOption("evolution")}
                  className="w-full p-3 bg-white/5 rounded-lg text-left hover:bg-white/10 transition"
                >
                  <div className="flex items-center justify-between">
            ...
            <div className="glass-effect rounded-2xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-purple-400 font-mono text-xs mt-1 break-all">
                    {profile.uploadedContent?.walrusCID || "Not uploaded"}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-white mt-1">
                    {profile.uploadedContent
                      ? `${(profile.uploadedContent.size / 1024 / 1024).toFixed(2)} MB`
                      : "0 MB"}
                  </p>
                </div>
              </div>
